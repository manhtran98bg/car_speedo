 ...
 */
    ...
    /* For host */
    #define ESP_PANEL_BOARD_LCD_SPI_IO_SCK          (3)
    #define ESP_PANEL_BOARD_LCD_SPI_IO_MOSI         (10)
    #define ESP_PANEL_BOARD_LCD_SPI_IO_MISO         (-1)    // -1 if not used
#endif // ESP_PANEL_BOARD_LCD_BUS_SKIP_INIT_HOST
    /* For panel */
    #define ESP_PANEL_BOARD_LCD_SPI_IO_CS           (2)     // -1 if not used
    #define ESP_PANEL_BOARD_LCD_SPI_IO_DC           (18)
 ...
 */
#define ESP_PANEL_BOARD_LCD_RST_IO              (21)    // Reset pin, -1 if not used
...
#define ESP_PANEL_BOARD_BACKLIGHT_TYPE          (ESP_PANEL_BACKLIGHT_TYPE_PWM_LEDC)
     ...
     */
    #define ESP_PANEL_BOARD_BACKLIGHT_IO        (42)    // Output GPIO pin number
